...
- The possibly to be save the ABI and the Bytecode, as mentioned at [Save the compilation result](#save-the-compilation-result). And this ABI can be used later to enable intellisense for the smart contract methods..
...
- Do you need more or something else :) try open an issue and we will discuss it...
